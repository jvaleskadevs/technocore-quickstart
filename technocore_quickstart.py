...
def validate_nonce(value: Union[str, int]) -> str:
...
def message_payload(room: str, nonce: Union[str, int], text: str) -> Tuple[str, bytes]:
...
def read_room(
    ...
    *,
    ...
    query: Dict[str, Union[str, int, float]] = {"format": "json", "limit": limit}
